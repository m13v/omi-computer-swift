    ...
    },
    {
        ...
        inputSchema: {
            ...
            properties: {
                type: {
                    type: "string",
                    description: "Permission type: screen_recording, microphone, notifications, accessibility, or automation",
                },
            },
            required: ["type"],
        },
...
const TOOLS = ALL_TOOLS.filter((t) => isOnboarding ? true : !ONBOARDING_TOOL_NAMES.has(t.name));
// --- JSON-RPC handling ---
function send(msg) {
    try {
...
async function handleJsonRpc(body) {
    ...
    switch (method) {
        ...
        case "tools/call": {
            ...
            else if (toolName === "check_permission_status" ||
