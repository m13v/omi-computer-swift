...
struct SettingsSearchItem: Identifiable {
    ...
    static let allSearchableItems: [SettingsSearchItem] = [
        ...
        SettingsSearchItem(name: "Excluded Apps", subtitle: "Screen capture is paused when these apps are active", keywords: ["exclude", "ignore", "block apps", "blocklist"], section: .rewind, advancedSubsection: nil, icon: "clock.arrow.circlepath", settingId: "rewind.excludedapps"),
        ...
        SettingsSearchItem(name: "CLAUDE.md", subtitle: "Personal instructions loaded into AI chat", keywords: ["claude md", "claude config", "instructions"], section: .aiChat, advancedSubsection: nil, icon: "cpu", settingId: "aichat.claudemd"),
        ...
        SettingsSearchItem(name: "Browser Extension", subtitle: "Lets the AI use your Chrome browser with all your logged-in sessions", keywords: ["playwright", "chrome", "browser extension", "browser"], section: .aiChat, advancedSubsection: nil, icon: "cpu", settingId: "aichat.browserextension"),

        // About
        SettingsSearchItem(name: "Software Updates", subtitle: "Check for and manage app updates", keywords: ["update", "auto update", "sparkle", "version", "check for updates"], section: .about, advancedSubsection: nil, icon: "info.circle", settingId: "about.updates"),
        ...
        SettingsSearchItem(name: "AI User Profile", subtitle: "AI-generated summary of your preferences and habits", keywords: ["profile", "generate"], section: .advanced, advancedSubsection: .aiUserProfile, icon: "brain", settingId: "advanced.aiuserprofile"),
        ...
        SettingsSearchItem(name: "Focus Analysis Prompt", subtitle: "Customize AI instructions for focus analysis", keywords: ["prompt", "analysis", "focus prompt", "custom prompt"], section: .advanced, advancedSubsection: .focusAssistant, icon: "eye.fill", settingId: "advanced.focusassistant.prompt"),
        ...
        SettingsSearchItem(name: "Task Extraction Prompt", subtitle: "Customize AI instructions for task extraction", keywords: ["prompt", "custom prompt", "task prompt", "test run", "test runner"], section: .advanced, advancedSubsection: .taskAssistant, icon: "checklist", settingId: "advanced.taskassistant.prompt"),
        ...
        SettingsSearchItem(name: "Task Prioritization", subtitle: "Re-score all tasks by relevance to your profile and goals", keywords: ["prioritize", "rescore", "relevance", "ranking"], section: .advanced, advancedSubsection: .taskAssistant, icon: "checklist", settingId: "advanced.taskassistant.prioritization"),
        ...
        SettingsSearchItem(name: "Advice Prompt", subtitle: "Customize AI instructions for advice", keywords: ["prompt", "custom prompt", "advice prompt"], section: .advanced, advancedSubsection: .adviceAssistant, icon: "lightbulb.fill", settingId: "advanced.adviceassistant.prompt"),
        ...
        SettingsSearchItem(name: "Memory Extraction Prompt", subtitle: "Customize AI instructions for memory extraction", keywords: ["prompt", "custom prompt", "memory prompt"], section: .advanced, advancedSubsection: .memoryAssistant, icon: "brain.head.profile", settingId: "advanced.memoryassistant.prompt"),
        ...
        SettingsSearchItem(name: "Report Issue", subtitle: "Send app logs and report a problem", keywords: ["bug", "feedback", "logs"], section: .advanced, advancedSubsection: .troubleshooting, icon: "wrench.and.screwdriver", settingId: "advanced.troubleshooting.reportissue"),
